...
protocol CheckboxGetColorsUseCaseable {
    ...
    func executeStatic(theme: Theme, intent: SelectionControlsIntent) -> CheckboxStaticColors
    // sourcery: theme = "Identical"
    func executeDynamic(theme: Theme, intent: SelectionControlsIntent, selectionState: CheckboxSelectionState) -> CheckboxDynamicColors
}
