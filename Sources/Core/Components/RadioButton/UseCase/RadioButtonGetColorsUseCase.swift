...
protocol RadioButtonGetColorsUseCaseable {
    ...
    func executeStatic(theme: Theme, intent: SelectionControlsIntent) -> RadioButtonStaticColors
    // sourcery: theme = "Identical"
    func executeDynamic(theme: Theme, intent: SelectionControlsIntent, isOn: Bool) -> RadioButtonDynamicColors
}
