...
enum CheckboxScenarioSnapshotTests: String, CaseIterable {
    ...
    func configuration() throws -> [CheckboxConfigurationSnapshotTests] {
        switch self {
        case .test1:
            return self.test1()
        case .test2:
    ...
    private func test1() -> [CheckboxConfigurationSnapshotTests] {
        let values = CheckboxValue.allCases
    ...
    /// - mode : light
    /// - a11y size : medium
    private func test2() -> [CheckboxConfigurationSnapshotTests] {
        let values = CheckboxValue.allCases
    ...
    /// - mode : light
    /// - **a11y size : **all**
    private func test5() -> [CheckboxConfigurationSnapshotTests] {
    ...
    private func documentation() -> [CheckboxConfigurationSnapshotTests] {
        let contentResiliences = CommonContentResilience.allCases
        let values = CheckboxValue.allCases
        let statutes = CommonStatus.allCases
