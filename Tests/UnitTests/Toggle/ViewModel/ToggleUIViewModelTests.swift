...
final class ToggleUIViewModelTests: XCTestCase {
    ...
    func test_load_shouldCallAllUseCases_exceptAnimationType() {
        ...
        // **
        // UseCase Calls Count
        ToggleGetAnimationTypeUseCaseableMockTest.XCTAssert(
...
private final class Stub: ToggleUIViewModelStub {
    ...
    init() {
        let getAnimationTypeUseCaseMock = ToggleGetAnimationTypeUseCaseableGeneratedMock()
...
private func XCTAssertNotCalled(
    ...
    if getAnimationTypeNotCalled {
        ToggleGetAnimationTypeUseCaseableMockTest.XCTCallsCount(
            stub.getAnimationTypeUseCaseMock,
    ...
    if getShowSpaceNotCalled {
        ToggleGetShowSpaceUseCaseableMockTest.XCTCallsCount(
            stub.getShowSpaceUseCaseableMock,
